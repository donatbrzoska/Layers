...
float3 pixel_to_world_space(int2 pixel, int texture_resolution, float3 surface_position, float2 surface_size)
{
...
float2 rakel_anchor_to_index_space(float3 anchor, int texture_resolution)
{
